        ...
        <div class="col-sm-2">
              <div class="col-sm-12">
                <div class="form-group">
                  <label>Cover</label>
                  <img src="<?php echo base_url('cover/' . $buku['cover']); ?>" id="gambar_load" class="img-fluid" width="200px" height="200px">
          ...
          <div class="col-sm-3">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <span class="input-group-append">
                        <a href="<?= base_url('Lokasi') ?>" class="btn btn-primary btn-flat">
                            <i class="fas fa-plus"></i>
                        </a>
                      </span>
                      </div>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <select name="tahun" class="form-control">
                          <option value="<?= $buku['tahun'] ?>"><?= $buku['tahun'] ?></option>
            ...
            <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <textarea rows="5" class="form-control" name="deskripsi"><?= $buku['deskripsi'] ?></textarea>
                    </div>
                </div>
          </div>
      </div>
