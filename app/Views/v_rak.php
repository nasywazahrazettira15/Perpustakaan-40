          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="lantai_rak" placeholder="Lantai" required>
                  </div>
            </div>
        ...
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                    <label>Lantai Rak</label>
                    <input type="number" class="form-control" value="<?= $value['lantai_rak']?>"name="lantai_rak" placeholder="Lantai" required>
                  </div>
            </div>
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-default btn-flat" data-dismiss="modal">Close</button>
